...
public class DataLoader {
    ...
    @Autowired
    public DataLoader(CommentRepository commentRepository, PostRepository postRepository, AuthorRepository authorRepository){
    ...
    private void createAuthors() {
        Author jv = new Author("Stilqn","Geo","stkwe@abv.bg");
        authorRepository.save(jv);
        Author av = new Author("Karen","Boss","karen@boss.com");
    ...
    private String getBody(){
        ...
        body += "In sit amet mi sollicitudin, iaculis erat venenatis, fringilla turpis. Suspendisse potenti. Curabitur sed molestie eros. Phasellus ultrices, nisi a egestas commodo, ante nisl lobortis diam, at molestie quam lorem eget tellus. Maecenas venenatis sapien ut euismod tempus. Nunc gravida vitae ante faucibus iaculis. Donec nulla dolor, placerat sit amet iaculis at, ornare quis turpis. Proin pharetra vel massa at vulputate. Phasellus efficitur pretium auctor. Mauris tincidunt velit metus, ac varius ante porta vel.";
